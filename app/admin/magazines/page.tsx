...
export default function AdminMagazinesPage() {
  ...
  async function loadMagazines(a: typeof applied) {
    setLoading(true);
    try {
      ...
      const data = await api.get<any>(`/admin/magazines?${params.toString()}`);
          ...
          <div>
            ...
            {meta && (
              <p className="mt-0.5 text-sm" style={{ color: "var(--bw-muted)" }}>
                {meta.total ?? magazines.length} magazine
                {(meta.total ?? magazines.length) !== 1 ? "s" : ""}
          ...
          {loading ? (
            ...
            <div className="py-16 sm:py-20 text-center px-4">
              ...
              <p className="text-sm" style={{ color: "var(--bw-ghost)" }}>
                Try adjusting your filters or create a new magazine.
              </p>
            </div>
          ) : (
            <div className="divide-y" style={{ borderColor: "var(--bw-divider)" }}>
              ...
              >
                <div className="sm:col-span-3">Magazine</div>
                <div className="sm:col-span-2 text-center">Templates</div>
                <div className="sm:col-span-2 text-center">Pages</div>
                ...
                >
                  ...
                  <div className="flex justify-between sm:col-span-2 sm:justify-center sm:text-center">
                    ...
                    <span className="text-sm">
                      {magazine.minPages}–{magazine.maxPages}
                    </span>
                  </div>
                  ...
                  {/* Actions */}
                  <div className="flex justify-end sm:col-span-3 gap-2">
                    <a
                      href={`/admin/magazines/${magazine._id}`}
                    ...
                    <button
                      type="button"
                      onClick={() => setDeleteConfirm(magazine._id)}
                      className="px-3 py-1.5 text-xs font-semibold rounded-[var(--bw-radius-md)] border transition-all cursor-pointer"
                      style={{
                        background: "var(--bw-bg)",
                        borderColor: "var(--bw-border)",
          ...
          >
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                type="button"
                onClick={() =>
                  deleteConfirm && deleteMagazine(deleteConfirm)
                }
...
function SkeletonRow({ delay }: { delay: number }) {
  ...
  return (
    ...
    >
      <div
        className="sm:col-span-3 h-4 rounded-md"
        style={{
          background: shimmer,
