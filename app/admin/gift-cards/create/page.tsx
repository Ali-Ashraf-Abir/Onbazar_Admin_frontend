...
export default function AdminCreateGiftCardPage() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Failed to create gift card"
      );
      console.error(err);
    } finally {
      setSaving(false);
          ...
          <div className="lg:col-span-2 flex flex-col gap-5 sm:gap-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "var(--bw-ghost)" }}
                  >
                    Active gift cards are available for customers to buy and
                    customize.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--bw-muted)" }}
              >
                Choose exactly one canvas template. A gift card is always a
                single page.
              </p>
              ...
              {templates.length === 0 ? (
                <div className="text-center py-8">
                  <p
                    ...
                    style={{ color: "var(--bw-muted)" }}
                  >
                    No canvas templates available. Create a canvas template
                    first.
                  </p>
                </div>
              ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <p
                          ...
                          style={{ color: "var(--bw-muted)" }}
                        >
                          {template.imagePlaceholders?.length || 0} images ·{" "}
                          {template.textPlaceholders?.length || 0} text fields
                        </p>
                      </button>
                    );
                  })}
          ...
          <div className="lg:col-span-1 flex flex-col gap-5 sm:gap-6">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div
                  className="h-px"
                  style={{ background: "var(--bw-divider)" }}
                />
